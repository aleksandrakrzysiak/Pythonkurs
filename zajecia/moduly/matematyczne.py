...
def pole_kola():
    ...
    if zajecia.moduly.walidator.walidacja(r) == True:
        wzor = 3.14 * float(r)**2
...
def parzysta():
    ...
    if zajecia.moduly.walidator.walidacja(number) == True:
        if (int(number) % 2 == 0):
...
def dziel_lub():
    ...
    if zajecia.moduly.walidator.walidacja(a) == True:
...
def przeliczenie():
    ...
    if zajecia.moduly.walidator.walidacja(bn) == True:
